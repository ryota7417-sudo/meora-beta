  ...
  const slides = [
    {
      ...
      body: t.slide1Body,
      // eslint-disable-next-line @next/next/no-img-element
      icon: <img src="/onboarding_01.png" alt="" style={{ maxHeight: 120, maxWidth: '100%', width: 'auto', height: 'auto', display: 'block', filter: 'invert(1)', mixBlendMode: 'screen' }} />,
    },
    {
      num: '02 / 04',
      title: t.slide2Title,
      body: t.slide2Body,
      // eslint-disable-next-line @next/next/no-img-element
      icon: <img src="/onboarding_02.png" alt="" style={{ maxHeight: 120, maxWidth: '100%', width: 'auto', height: 'auto', display: 'block', filter: 'invert(1)', mixBlendMode: 'screen' }} />,
    },
    {
      num: '03 / 04',
      title: t.slide3Title,
      body: t.slide3Body,
      // eslint-disable-next-line @next/next/no-img-element
      icon: <img src="/onboarding_03.png" alt="" style={{ maxHeight: 120, maxWidth: '100%', width: 'auto', height: 'auto', display: 'block', filter: 'invert(1)', mixBlendMode: 'screen' }} />,
    },
    {
      num: '04 / 04',
      title: t.slide4Title,
